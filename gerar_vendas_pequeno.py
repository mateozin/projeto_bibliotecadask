"""
arquivo para gerar dados para o teste pandas x dask com mais ou menos 1MB de arquivos 
aproximadamente 30.000 de registros
"""
...
def gerar_dados_peq():
    ...
    print(f"\n{'='*55}")
    print(f"  Gerando dataset: PEQUENO")
    print(f"  ~{total_linhas:,} linhas  |  ~3 MB  |  pasta: {PASTA}/")
    print(f"{'='*55}")
