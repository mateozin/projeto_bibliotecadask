"""
arquivo para gerar dados para o teste pandas x dask com mais ou menos 80MB de arquivos 
aproximadamente 3.000.000 de registros
"""
...
def gerar_dados_med():
    ...
    print(f"Gerando {len(MESES)} arquivos com {LINHAS_MES:,} linhas cada ({total_linhas:,} total)...\n")
    ...
    for mes in MESES:
        ...
        print(f" {nome}  ({len(df):,} linhas, {tamanho_mb:.1f} MB)  [{elapsed:.1f}s]")
