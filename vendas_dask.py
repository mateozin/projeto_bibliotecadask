"""
le os dados (.csv) criados com os outros códigos usando pandas ou dask
...
if len(glob.glob("dados_pequeno/*.csv")) == 0:
    print("Nenhum [PEQUENO] .csv encontrado, criando novos..")
    gerar_dados_peq()
else:
    print("Arquivos .csv já existente, executando o código normalmente...")
...
while True:
    ...
    #PEQUENO
    if escolha == "1":
        if len(glob.glob("output/comparacao_peq.png")) == 0:
            print("Gráfico não encontrado, criando...")
            ...
            print("Gráfico salvo em output/comparacao_peq.png")
                    ...
                    image = mpimg.imread('output/comparacao_peq.png')
                    plt.imshow(image)
                    plt.show()
        ...
        if len(glob.glob("output/comparacao_med.png")) == 0:
            print("Gráfico não encontrado, criando...")
            ...
            image = mpimg.imread('output/comparacao_med.png')
            plt.imshow(image)
            plt.show()
            print("Gráfico já existe.")
    ...
    #Grande
        ...
        if len(glob.glob("output/comparacao_grande.png")) == 0:
            print("Gráfico não encontrado, criando...")
            ...
            image = mpimg.imread('output/comparacao_grande.png')
            plt.imshow(image)
            plt.show()
            print("Gráfico já existe.")
    #Grande e Complexo
    elif escolha == "4":
        if len(glob.glob("output/comparacao_grcomp.png")) == 0:
            print("Gráfico não encontrado, criando...")
            ...
            image = mpimg.imread('output/comparacao_grcomp.png')
            plt.imshow(image)
            plt.show()
            print("Gráfico já existe.")
    elif escolha == "0":
